...
import { MdCheck, MdClose, MdError, MdRemove } from "react-icons/md"
...
const Rsvp = () => {
    ...
    if (!guests)
        return (<form className="flex flex-col gap-6 items-center" onSubmit={(e) => { e.preventDefault(); handleContinue() }}>
                    <span className="text-center uppercase font-bold tracking-[0.4px] md:text-4xl text-2xl">
    ...
    return (<div className="flex flex-col gap-6 items-center">
                <div className="flex flex-col gap-2">
                    ...
                    <span>Favor confirmar até o dia <strong>29 de Julho de 2026</strong>.</span>
                </div>
